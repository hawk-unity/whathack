...
#  apt-get güncelle
def sql():
    webbrowser.open("https://www.youtube.com/watch?v=6I-NMcyyvkc&t=1s")
...
# xss nedir ?
def xss():
    webbrowser.open("https://www.youtube.com/watch?v=-IiJQd0Ss70&t=113s")
...
# youtube aç
def bypass():
    webbrowser.open("https://www.youtube.com/watch?v=ObkIa-NKYFw&t=29s")
# ddos nedir ?
def ddos():
    webbrowser.open("https://www.youtube.com/watch?v=1PVObfFRK0o&t=1s")
    print(""" 
        DDoS Nedir?
...
Label(root,text="H4WK OFCX",font="Helvtica 10" ,bg="black" , fg="white").pack()
